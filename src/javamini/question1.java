...
public class question1 extends javax.swing.JFrame {
    ...
    int quizanswered=0;
    int marks=0;
    public question1(String user, String pass) {
        initComponents();
        this.user=user;
        this.pass=pass;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Which component is used to compile, debug and execute the java programs?");
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"Please select and answer ");
            ...
            new question2(quizanswered,marks,user,pass).setVisible(true);
            this.dispose();
        }
